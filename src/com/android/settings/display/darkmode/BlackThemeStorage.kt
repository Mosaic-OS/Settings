...
class BlackThemeStorage(private val context: Context) :
    AbstractKeyedDataObservable<String>(), KeyValueStore {

    private val settingsObserver =
        object : ContentObserver(Handler(Looper.getMainLooper())) {
            override fun onChange(selfChange: Boolean) {
                notifyChange(Settings.Secure.THEME_AMOLED_BLACK, PreferenceChangeReason.VALUE)
            }
        }

    override fun contains(key: String) = key == Settings.Secure.THEME_AMOLED_BLACK
    ...
    override fun <T : Any> setValue(key: String, valueType: Class<T>, value: T?) {
        ...
        Settings.Secure.putInt(
            ...
            Settings.Secure.THEME_AMOLED_BLACK,
