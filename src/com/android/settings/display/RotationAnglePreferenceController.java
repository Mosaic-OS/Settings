...
public class RotationAnglePreferenceController extends AbstractPreferenceController
    ...
    // Bit layout of Settings.System.ACCELEROMETER_ROTATION_ANGLES. Bit 0 (regular portrait)
    // is always allowed and is not user-togglable on this screen.
    ...
    // Default mask used when the setting is unset. Must stay in sync with the
    // android:defaultValue entries in res/xml/rotation_settings.xml (90 = on, 180 = off,
    // 270 = on) plus the always-allowed 0deg. 0b1011 == 11.
