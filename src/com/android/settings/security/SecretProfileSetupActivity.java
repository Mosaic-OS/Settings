...
public class SecretProfileSetupActivity extends SecretProfileActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Always treat as "Add" - we always create a fresh secret profile.
    ...
    private void save() {
        ...
        // The credential teardown/rewrite below makes several binder calls (removeUser,
        // delete/set secret credentials) that can block; run them off the UI thread to
        // avoid an ANR, then post the result back to the main thread.
        Runnable save = () -> ThreadUtils.postOnBackgroundThread(() -> {
            Exception error = null;
            try {
                // Delete existing secret profile user (if any) and credentials before
                // creating fresh ones. This ensures a clean slate every time.
                ...
                // Delete existing credentials regardless of profile existence.
                ...
                // Wipe the in-memory credential material as soon as we are done with it
                // instead of relying on the delayed System.gc() in the base activity.
                pin.zeroize();
                password.zeroize();
        ...
        warning.setPositiveButton(R.string.duress_pwd_proceed_button, (d, w) -> save.run());
        warning.show();
    }
